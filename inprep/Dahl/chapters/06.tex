...
\includegraphics[height=.3\textheight]{figures/26_BorderlinesofMedAf}
...
\includegraphics[height=.3\textheight]{figures/30_DistributionHjärJär}
...
he  \textbf{put{\pst}} money.{\pl}.{\def}  in  wallet.{\def}\\
...
\begin{figure}[h] 
\includegraphics[height=.3\textheight]{figures/31_DistributionofKuta}
...
\begin{figure}[h] 
%\includegraphics[height=.3\textheight]{figures/32_DistributionofHäva}
...
\includegraphics[height=.3\textheight]{figures/33_CoreAreasReinhammer}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/34_CoreAreasVallmark}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/35_RetainmentofVarda}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/36_CognatesCatCorpus}
\caption{Cognates of \textstyleLinguisticExample{fæghin} in the Cat Corpus (filled circles).}
\label{map:32}
\end{figure}

\begin{figure}[h]
%\includegraphics[height=.3\textheight]{figures/37_DistributionofHitta}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/38_DistributionConservativeFeatures}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/39_DistributionInnovativeFeatures}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/40_GrowthofPermSettled}
\caption{Growth of permanently settled areas between approx. 800CE and 1350CE. }
\label{map:36}
\end{figure}

\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/42_CitiesandTowns}
\caption{Cities and towns in the Mälar region  in the late 13th century. }
\label{map:37}
\end{figure}

\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/43_PopulationUppland}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/44_UpplandHighActivity}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/45_Kruuse}
...
\begin{figure}[h]
\includegraphics[height=.3\textheight]{figures/46_Mysterious}
