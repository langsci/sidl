...
then  stand.{\pst}  \textbf{Lord.{\deff}-{\poss}} \textbf{angel} in front of  they.{\obl}\\
...
tomcat.{\deff}  understand.{\pst}\\
\gll att  hanna  va  \textbf{kälinga} \textbf{hansch} \textbf{‘n} \textbf{Allfre.}\\
that  {\dem}  be.{\pst}  \textbf{wife.{\deff}} \textbf{his} \textbf{{\pda}.{\m}} \\
...
old.{\supp}ERL  boy.{\deff}  have.{\pst}  go.{\supp}  \textbf{to} \textbf{America.{\deff}}\\
...
\langinfo{Älvdalen (Os)}{}{}\\
\gll Og  ǫ  add  gaið\\
and  she  have.{\pst}  go.{\supp}\\
\gll fromǫ  \textbf{gamman} \textbf{að} \textbf{nogum} \textbf{momstaskallum.}\\
in front of   \textbf{front\_roof} \textbf{to} \textbf{some.{\deff}.{\pl}} \textbf{Månsta\_people}\\
