...
%%%
\subsection*{Aim}
% \todo[inline]{should this be section 1.1, etc? Micha: if you prefer, but I personally would rather like to keep it like this}
%%%
...
The method of sampling and mapping of data is inspired by the \emph{AUTOTYP}\footnote{Cf.~\url{http://www.spw.uzh.ch/autotyp/} 16.02.2014}\is{AUTOTYP} and \emph{\isi{EUROTYP}}\footnote{Cf.~\url{http://www.degruyter.com/view/serial/16329} 16.02.2014} research programs as well as the \emph{WALS} project \citep{walsOnline2013}.\is{WALS} The approach presented here is closer to \emph{\isi{EUROTYP}} than to \emph{WALS}\is{WALS} or \emph{AUTOTYP}\is{AUTOTYP} in coding as many different genera from the geographic area of investigation as possible.
\todo[inline]{Andi: link is defective, should be included into bibliography, wrong format\\Bickel, Balthasar \& Johanna Nichols. 2016. AUTOTYP. (\url{http://www.autotyp.uzh.ch/}) (Accessed 2016-06-04.)}
\todo[inline]{Andi:wrong format, include into bibliography\\Eurotyp. Typology of Languages in Europe. Berlin: De Gruyter Mouton. (\url{http://www.degruyter.com/view/serial/16329}) (Accessed 2016-06-04.)}
