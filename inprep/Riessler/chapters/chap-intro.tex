...
The method of sampling and mapping of data is inspired by the \emph{AUTOTYP}\footnote{Cf.~\url{http://www.spw.uzh.ch/autotyp/} 16.02.2014}\is{AUTOTYP} and \emph{Eurotyp}\footnote{Cf.~\url{http://www.degruyter.com/view/serial/16329} 16.02.2014}\is{EUROTYP} research programs as well as the \emph{WALS} project \citep{walsOnline2013}.\is{WALS} The approach presented here is closer to \emph{Eurotyp}\is{EUROTYP} than to \emph{WALS}\is{WALS} or \emph{AUTOTYP}\is{AUTOTYP} in coding as many different genera from the geographic area of investigation as possible.
