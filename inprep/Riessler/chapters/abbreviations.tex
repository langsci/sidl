...
\begin{tabbing}
\TABh \= \kill
\textsc{abess} \> abessive\is{case marking!essive}\\
...
\textsc{contr} \> contrastive focus\is{focus marking!contrastive focus}\\
\textsc{crs} \> currently relevant state\\
\textsc{deriv} \> derivative, derivation\\ \> (unspecified)\\
\textsc{dim} \> diminutive\\
\textsc{ess} \> essive\is{case marking!essive}\\
\textsc{hum} \> human (gender)\\
\textsc{ill} \> illative\is{case marking!illative}\\
\textsc{infl} \> (any) inflection\\
\textsc{mod} \> modification\is{modification marking}\\
\textsc{nar} \> narrative (case)\is{case marking!narrative}\\
...
\textsc{prepos} \> prepositional\is{case marking!prepositional}\\
\textsc{real} \> realis\\
...
\is{attributive state!dependent-marking|see{anti\hyp{}construct state}}
