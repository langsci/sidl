...
\end{exe}
%%%
Whereas agreement is obligatory for all three number values, case agreement is defective.\is{agreement marking!defective agreement paradigm} Only in nominative, genitive and accusative, the corresponding case values are inherit from the head noun. If the noun phrase is marked for one of the other cases, the adjective is inflected in genitive (\citealt[511]{helimski1998a}; \citealt[157]{wagner-nagy2002a}).
\il{Nganasan|)}
\il{Head-driven agreement|)}
\il{North Samoyedic languages|)}
