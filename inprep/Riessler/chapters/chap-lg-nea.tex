...
\end{exe}	
%%%
The marker \textit{-di\textsuperscript{1}} is clearly cognate with the functionally similar nominalizer \textit{-de} in Mandarin Chinese\il{Mandarin Chinese} (cf.~Example \ref{multi mand} in Section \ref{polyfunctionality}). In Dungan, however, \textit{-di\textsuperscript{1}} is sometimes also described as a marker of predicative\is{predicative marking} adjectives, as in (\ref{dungan emphpred}).
%%%
\begin{exe}
...
Similar to Evenki\il{Evenki} from the northern branch of Tungusic, the Udege-Oroch languages from the Amur branch exhibit modifier-headed possessor agreement. Oroch examples for this type of adjective attribution marking have already been discussed in Section \ref{ModheadAgr} but will be repeated here.
%%%
\begin{exe}
...
\il{Manchu languages|(}
\subsection{Manchu}
The two Manchu languages Manchu proper\il{Manchu proper} and Sibe\il{Sibe} exhibit juxtaposition as the default adjective attribution marking device similar to the Nanay-Ulcha-Orok\il{Nanay-Ulcha-Orok languages} languages.
\il{Manchu languages|)}
\il{Tungusic languages|)}
...
%%%
Yukagir (aka Yukaghir)\il{Yukaghir languages|see{Yukagir languages}} is a small family consisting of the two single languages Tundra Yukagir\il{Tundra Yukagir} and Kolyma Yukagir\il{Kolyma Yukagir} (aka Forest Yukagir)\il{Forest Yukagir|see{Kolyma Yukagir}}  (\citealt[223]{salminen2007}; \citealt[1–2]{maslova2003a}; \citealt[1]{maslova2003b}).\\
...
The Bulgar (aka Oghur)\il{Oghur Turkic languages|see{Bulgar Turkic languages}} subbranch of the Turkic language family is represented only by a single language, Chuvash.
...
\subsection{Adyge}
%%%
The Adyge (aka Adyghe\il{Adyghe languages|see{Adyge languages}} or Circassian)\il{Circassian languages|see{Adyge languages}} branch of Abkhaz-Adyge comprises the two languages Adyge\il{Adyge} proper and Karbardian.\il{Karbardian} Both languages exhibit similar noun phrase structures. The constituent order inside the noun phrase is normally noun-adjective. Noun phrases with modifying adjectives in Adyge and Karbardian are often described as single compound words \citep[222]{comrie1981}.
