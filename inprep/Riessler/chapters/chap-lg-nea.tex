...
\lspbottomrule
\end{tabular}
\caption[Article paradigm for Rumanian]{Agreement paradigm of the attributive article in Rumanian \citep[94]{beyer-etal1987}.\todo[inline]{Vielleicht wäre es hier besser, die doppelten Einträge auch doppelt zu nennen, um vertikale Linien überflüssig zu machen\\Es sind keine "doppelten Einträge" sondern Synkretismen, d.h. es gibt nur eine morphologische Form für mehrere Kategorien}} \label{rumanian art}
\end{table}
%%%
\is{definite marking|(}
