...
\begin{exe}
\il{Ainu!Shizunai}
\ex \rm{Ainu (Shizunai) (isolate; \citealt[142]{refsing1986})}%!!CHECK PAGES
\begin{xlist}
...
The Sino-Tibetan language family is represented in northern Eurasia only by one language, Dungan (aka Dunganese),\il{Dunganese|see{Dungan}} which is a Gansu\il{Gansu languages} variety of Chinese spoken in the Kyrgyz Republic in Central Asia (cf.~\citealt[85]{yuo2003}, \citealt{kalimov1968}).\\
...
The Danish dialect {\bf Western Jutlandic},\il{Danish!W-Jutlandic} finally, is most innovative with regard to the decline of agreement features because it has almost completely lost its agreement features and thus resembles English (Table~\ref{jutl agr paradigm}).
\il{Danish|)}
