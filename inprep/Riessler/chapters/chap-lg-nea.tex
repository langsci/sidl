...
%%%
\begin{exe}
\ex \langinfo{Central Siberian Yupik}{Eskimo-Aleut}{\cite{de-reuse1994}}
\begin{xlist}
\ex
...
%%%
\begin{exe}
\ex \langinfo{Chukchi}{Chukotkan}{\citealt[Vladimir Nedjalkov, pc][330]{rijkhoff2002}}
\begin{xlist}
...
%%%
\begin{exe}
\ex \rm{Anti-construct state agreement in \langinfo{Itelmen}{Kamchatkan}{\citealt{georg-etal1999}}}\\
...
%%%
\begin{exe}
\ex \label{nivkh redup} \langinfo{Nivkh}{isolate}{Ekaterina Gruzdeva, pc}\is{Gruzdeva, Ekaterina}
\begin{xlist}
\ex 
...
\todo{Martin: kono?}
\begin{exe}
\ex \rm{Verbal adjectives in \langinfo{Japanese}{isolate}{\citealt[170]{backhouse1984}}}
\begin{xlist}
...
%%%
\begin{exe}
\ex \langinfo{Japanese}{isolate}{\citealt[72–81]{pustet1989}}%!!REF stimmt nicht
\begin{xlist}
...
%%%
\begin{exe}
\ex \langinfo{Korean}{isolate}{\citealt[61]{chang1996}}
\begin{xlist}
\ex
\begin{xlist}
\ex
...
%%%
Yukaghir (aka Yukagir)\il{Yukagir|see{Yukaghir languages}} is a small family consisting of the two single languages Tundra Yukaghir\il{Tundra Yukaghir} and Kolyma Yukaghir\il{Kolyma Yukaghir} (aka Forest Yukaghir)\il{Forest Yukaghir|see{Kolyma Yukaghir}} (\citealt[223]{salminen2007}; \citealt[1–2]{maslova2003a}; \citealt[1]{maslova2003b}).\\

\noindent Noun phrases show strictly head-final word order in both Yukaghir languages. True adjective attribution scarcely exists because modifying “property words” in noun phrases are best coded as relative clauses.\is{relative clause}\\

\noindent The following relevant attribution marking types are attested in Yukaghir languages:
%%%
\begin{itemize}
\item Incorporation
\item Anti-construct state marking
...
\paragraph{Anti-construct state marking in Kolyma Yukaghir}
...
%%%
\begin{exe}
\ex 	\textsc{Kolyma Yukaghir} \citep{maslova2003b}
\begin{xlist}
...
\il{Tundra Yukaghir|(}
\paragraph{Anti-construct state marking in Tundra Yukaghir}
...
%%%
\begin{exe}
\ex 	\textsc{Tundra Yukaghir} \citep[50]{maslova2003a}
...
%%%
\begin{exe}
\ex \textsc{Tundra Yukaghir} \citep{maslova2003a}
\begin{xlist}
...
\glt	‘the legs of his cow’\footnote{The regular use of the cognate attribution marker \textit{-d} (\textit{\textasciitilde-n}) with nouns and noun phrases as attributes is described for Kolyma Yukaghir as well. The use of the marker as a licensee of adjective attribution, however, seems to be restricted to one adjective ‘new’ \citep[71]{maslova2003b}.} (44)
\end{xlist}
\end{exe}
\il{Tundra Yukaghir|)}
\il{Yukaghir languages|)}
