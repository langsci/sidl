...
\begin{xlist}
\ex[*]{kuasse		\jambox{ \rm{\ili{Proto-Saamic}} }}
...
\begin{xlist}
\ex[*]{kuasse-sē	\jambox{ \rm{\ili{Proto-Saamic}} }}
...
Furthermore, the nominalizing function of the (person-deictic) marker of possession is attested not only in several \ili{Uralic languages} but also in \ili{Turkic languages}. And, finally, a typologically similar development of a (local-deictic) demonstrative to an attributive article is also attested in \ili{Indo-European languages} of the area.
...
\begin{xlist}
\ex \rm{Stage 1: \ili{Pre-Proto-Saamic}}
\begin{xlist}
\ex \rm{Juxtaposition}\\
	$[_{NP}$ $_{A}$long $_{N}$stocking$]$
\end{xlist}
%%%
\ex \rm{Stage 2a: \ili{Proto-Saamic}}
\begin{xlist}
