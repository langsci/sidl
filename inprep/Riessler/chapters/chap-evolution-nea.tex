...
This pronominal part of the long-form agreement suffix likely goes back to a pronominal stem reconstructed as \ili{Proto-Indo-European} \textit{*i̭o-} \citep[61]{wissemann1958}. The anti-construct state agreement marker in Baltic/Slavic could thus be cognate with relative markers in other Indo-European languages, such as Old Indic\il{Old Indic languages} \textit{yá-h}, Old Iranian\il{Old Iranian languages} \textit{yō}, or \ili{Greek} \textit{ős} \cite[53]{heinrichs1954}.
...
%%%
\begin{exe}
\ex “Strong” and “weak” agreement in \langinfo{Proto-Germanic}{Indo-European}{\citealt[169]{ringe2006}}\\
\begin{xlist}
