...
{\ob}\textsubscript{\upshape NP} \textsubscript{\upshape A}big-\textsc{agr} \textsubscript{\upshape N}house{\cb}
%%%
\ex	{\upshape Attributive apposition (emphatic)}\\
\label{germanic art1}
{\ob}\textsubscript{\upshape NP} {\ob}\textsubscript{\upshape NP'} \textsubscript{\upshape A}big \textsubscript{\upshape HEAD}Ø-\textsc{nmlz}{\cb} \textsubscript{\upshape N}house{\upshape ]]}
\end{xlist}
%%%
\ex
\label{germanic2}
...
{\ob}\textsubscript{\upshape NP} \textsubscript{\upshape A}big-\textsc{agr:contr} \textsubscript{\upshape N}house{\cb}
\end{xlist}
%%%
\ex
\label{germanic3}
...
\begin{xlist}
\ex 	{\upshape Agreement marking (default)}\\
{\ob}\textsubscript{\upshape NP} \textsubscript{\upshape A}big-\textsc{agr:attr} \textsubscript{\upshape N}house{\cb}
\end{xlist}
\end{xlist}
\end{exe}
%%%
...
\ex {\upshape Attributive apposition (emphatic)}\\
\label{germanic art2}
{\ob}\textsubscript{\upshape NP} {\ob}\textsubscript{\upshape NP'} \textsubscript{\upshape ART}the \textsubscript{\upshape A}big-\textsc{agr:attr} \textsubscript{\upshape HEAD}Ø{\cb} \textsubscript{\upshape N}house{\cb}
\end{xlist}
\ex {\upshape Stage 4}
\begin{xlist}
\ex {\upshape Definiteness marking}\\
\label{germanic def}
{\ob}\textsubscript{\upshape NP} \textsubscript{\upshape DEF}the \textsubscript{\upshape A}big-\textsc{agr:attr} \textsubscript{\upshape N}house{\cb}
\end{xlist}
\end{xlist}
\end{exe}
%%%
...
\label{ngermanic def}
{\ob}\textsubscript{\upshape NP} \textsubscript{\upshape ATTR:AGR}the\textsubscript{\upshape agr:attr} \textsubscript{\upshape A}big-\textsc{agr:attr} \textsubscript{\upshape N}house-\textsc{def}{\cb}
\end{xlist}
\end{xlist}
\end{exe}
%%%
...
\ex {\upshape Västerbotten Swedish}\footnote{The examples are constructed according to \citet{astrom1893}, cf.~also Delsing (\citeyear[122–123]{delsing1993}) and \cite{dahl2003}.}
\begin{xlist}
...
%%%
\ex {\upshape Attributive apposition (emphatic)}\\
	{\ob}\textsubscript{\upshape NP} {\ob}\textsubscript{\upshape NP'} \textsubscript{\upshape A}long \textsubscript{\upshape HEAD}Ø-\textsc{nmlz}{\cb} \textsubscript{\upshape N}stocking{\cb}
\end{xlist}
\ex {\upshape Stage 3: modern Saamic languages}
\begin{xlist}
\ex {\upshape Anti\hyp{}construct state marking}\\
	{\ob}\textsubscript{\upshape NP} \textsubscript{\upshape A}long-\textsc{attr} \textsubscript{\upshape N}stocking{\cb}
\end{xlist}
\end{xlist}
\end{exe}
%%%
