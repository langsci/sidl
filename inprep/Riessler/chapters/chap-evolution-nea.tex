...
%??By the way, on the history of “long” versus “short” adjectives in Russian, see works by Karin Larsen (2005, 2006, 2007).
...
\label{germanic art1}
$[_{\text{NP}}$ $[_{\text{NP'}}$ $_{\text{A}}$big $_{\text{HEAD}}$Ø-\textsc{nmlz}$]$ $_{\text{N}}$house$] ]$
\end{xlist}
%%%
\ex
\label{germanic2}
...
$[_{\text{NP}}$ $_{\text{A}}$big-\textsc{agr:contr} $_{\text{N}}$house$]$
\end{xlist}
%%%
\ex
\label{germanic3}
...
\label{ngermanic def}
$[_{\text{NP}}$ $_{\text{ATTR:AGR}}$the$_{\text{agr:attr}}$ $_{\text{A}}$big-\textsc{agr:attr} $_{\text{N}}$house-\textsc{def}$]$
\end{xlist}
\end{xlist}
\end{exe}
%%%
