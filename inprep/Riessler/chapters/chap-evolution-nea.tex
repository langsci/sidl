...
%%%
\begin{exe}
\ex \rm{Juxtaposition versus anti-construct state agreement marking (contrastive focus, in parentheses) \citep{kelmakov-etal1999,winkler2001}}
\begin{xlist}
...
\ex \label{koch rel}
\begin{xlist}
\ex	\rm{Nominal relative constructions in \langinfo{Pre-Proto-Baltic/Slavic}{Indo-European}{\citealt[468]{koch1999}}}\footnote{The example is glossed in accordance to Koch; a translation is missing in the source.}\\
...
\ex	\rm{\ili{Proto-Baltic/Slavic} attributive article}\\ \label{koch nomzr}
