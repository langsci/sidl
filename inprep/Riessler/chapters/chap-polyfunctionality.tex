...
\end{itemize}
\todo{LATEX: item-subitem (Style guide?)}
%%%
In Gil's\is{Gil, David} sample, Europe\is{Europe} and adjacent parts of Asia\is{Asia} and Africa\is{Africa} stand out as an area with predominantly non-polyfunctional languages, while almost all languages of Southeast Asia\il{Southeast Asian languages} are of low differentiation \citep[8]{gil2005}.
...
%gibt es eine Publikation inzwischen?
%%%
\begin{exe}
