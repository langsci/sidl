...
\midrule
\multicolumn{2}{r}{\textit{Yukaghir}}	&\textit{2}&\textit{2}&–&\textit{1.00}		&–\il{Yukaghir languages}\\\midrule
...
\label{diversity}
\end{longtable}\todo{kursivgesetzte Zahlen noch nicht optimal ausgerichtet.}
%\end{footnotesize}
