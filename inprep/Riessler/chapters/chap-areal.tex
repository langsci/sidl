...
%%%
%!!the formula of DiversityGenus should yield numbers below 1 for Saamic and Slavic — if we divide the number of types in a genus by the number of types in the whole family, and not vice versa.
