...
%%%
\begin{enumerate}
\item Anti-construct state\\as in \ili{Kildin Saami}
\item Anti-construct state + head\hyp{}driven agreement (“double agreement”)\\as in \ili{Swedish}
\item Anti-construct state + construct state (“double-construct state”)\\as in \ili{Northern Saami}
\item Anti-construct state agreement\\as in \ili{Russian}
\item Appositive head\hyp{}driven agreement\\as in \ili{Georgian}
\item Attributive article\\as in \ili{Yiddish}
\item Attributive article + head\hyp{}driven agreement (“double agreement”)\\as in \ili{Albanian}%??nominalization
\item Attributive nominalization\\as in \ili{Udmurt}
...
\item Head\slash{}driven agreement\\as in \ili{Finnish}
\item Modifier-headed possessor agreement\\as in \ili{Oroch}
\end{enumerate}
%%%
Only one type attested in the world-wide sample (see the appendix) does not occur in the northern Eurasian area: the floating construct state marker (\textit{linker}) found, for instance, in \ili{Tagalog} (Austronesian). 
...
The most rare types are: (1) modifier-headed possessor agreement, which is attested only as a secondary device in a few \ili{Tungusic languages}, and (2) the combined construct device (i.e.~“double-construct state”), which is attested only marginally in one single language, \ili{Northern Saami} (Uralic). Attributive nominalization combined  with head\hyp{}driven agreement is also very rare. This type occurs as the primary device only in the \ili{Albanian languages} (Indo-European), but it is also attested as a secondary or tertiary device in a few other languages. Head-marking construct state is also relatively uncommon in the northern Eurasian area as it is attested only in \ili{Iranian languages} (Indo-European).

The most common type is juxtaposition, followed by head\hyp{}driven agreement.

\section{Prototypes of attribution marking devices}
%%%
Several language families of northern Eurasia exhibit clear prototypes of adjective attribution marking devices: All Mongolic\il{Mongolic languages} and Turkic\il{Turkic languages} languages have juxtaposition as the default device, as is the case for the languages of most branches of Uralic\il{Uralic languages} as well. Head\slash{}driven agreement occurs as another prototype in many branches of the Indo-European\il{Indo-European languages} family. Even though the attested deviation from the prototype is much higher in Indo-European\il{Indo-European languages} than in Mongolic,\il{Mongolic languages} Turkic\il{Turkic languages} and Uralic,\il{Uralic languages} head\hyp{}driven agreement marking can be shown to occur prototypically in most Indo-European\il{Indo-European languages} genera.
