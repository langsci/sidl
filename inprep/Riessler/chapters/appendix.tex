...
\addsec{Genus abbreviations (families)}
%%%
\begin{flushleft}
...
\addsec{Genus abbreviations (branches and subbranches)}
%%%
\begin{flushleft}
...
\todo[inline]{all graphics are still the same}
...
\includegraphics[width=\textwidth]{figures/WorldMapTyp.jpg}%!!dummy
\label{WorldMap}
\end{sidewaysfigure}
