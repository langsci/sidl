...
\addsec{Taxon abbreviations (families)}
%%%
\begin{flushleft}
...
\addsec{Taxon abbreviations (branches and subbranches)}
%%%
\begin{flushleft}
...
\addsec{Geographic (sample) abbreviations}
%%%
\begin{flushleft}
...
\begin{tabular}{llllcccclll}\label{sample8}
...
{	AB-AD	}	&	ADYG	&		&	\textsc{	Adyghe (Abzakh)	}	&	X	&	–	&	–	&	–	&	Inc	&	\citealt{paris1989}\il{Adyghe!Abzakh}\\
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
\begin{tabular}{llllcccclll}\label{sample1}
\\%LATEX does not compile without this empty line
\lsptoprule
\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
%\hline%\midrule
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
		\begin{tabular}{llllcccclll}\label{sample2}
			\\%LATEX does not compile without this empty line
			\lsptoprule
			\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
			%\hline%\midrule
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
		\begin{tabular}{llllcccclll}\label{sample3}
			\\%LATEX does not compile without this empty line
			\lsptoprule
			\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
			%\hline%\midrule
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
		\begin{tabular}{llllcccclll}\label{sample4}
			\\%LATEX does not compile without this empty line
			\lsptoprule
			\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
			%\hline%\midrule
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
		\begin{tabular}{llllcccclll}\label{sample5}
			\\%LATEX does not compile without this empty line
			\lsptoprule
			\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
			%\hline%\midrule
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
		\begin{tabular}{llllcccclll}\label{sample6}
			\\%LATEX does not compile without this empty line
			\lsptoprule
			\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
			%\hline%\midrule
...
\begin{sidewaystable}
\resizebox{.9\textwidth}{!}{
		\begin{tabular}{llllcccclll}\label{sample7}
			\\%LATEX does not compile without this empty line
			\lsptoprule
			\multicolumn{4}{c}{Genealogical affiliation}&\multicolumn{4}{c}{Geographic sampling}&Noun phrase type(s)&\\\cmidrule(lr){1-4}\cmidrule(lr){5-8}%\cmidrule(lr){9-9}
			%\hline%\midrule
...
\newpage
\begin{sidewaysfigure}
 \caption[Adjective attribution marking, North Eurasia]{Adjective attribution marking in the languages of North Eurasia; 85 languages representing all taxa of the area}
...
\newpage
\begin{sidewaysfigure}
 \caption[Adjective attribution marking, North Eurasia, main types]{Adjective attribution marking in the languages of North Eurasia; 85 languages representing all taxa of the area coded for main morpho-syntactic types}
