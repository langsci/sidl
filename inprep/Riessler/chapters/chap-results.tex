...
\end{exe}
%%%
State marking is not restricted to noun phrase structure. In the following example, a state marker (glossed as a “modification marker”) marks a noun phrase as the dependent constituent inside an adposition phrase.
%%
\begin{exe}
\ex
