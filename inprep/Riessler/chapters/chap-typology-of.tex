...
\glt	 ‘he is a sick one (viz.~mentally sick)’\label{ru-pred-long}
\end{xlist}
\end{exe}
%%%
...
\glt	‘the \textsc{green} eyes’\label{yiddish attr defarticle}
\ex	
\gll	'n grin-et oyge\\
...
\glt	‘a \textsc{green} eye’\label{yiddish attr indefarticle}
\end{xlist}
\end{exe}
%%%
