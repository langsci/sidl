...
marking		&\cellcolor{lightgray}&			&$[\textsubscript{\rm NP}$ A (N){\upshape ]}				&$[\textsubscript{\rm NP}$ A *(N){\upshape ]}&\cellcolor{lightgray}&\cellcolor{lightgray}\\
\hline
\hline
			& 			&			&\textbf{Linker}						&			&			&\\
floating		&{\upshape [}–AGR{\upshape ]}	&			&$[\textsubscript{\rm NP}$ A {\upshape [}\textsc{attr}{\upshape ]} *(N){\upshape ]}	&			&			&\\
 			\cline{2-5}
			&{\upshape [}+AGR{\upshape ]}	&			&							&			&			&\\
			&			&			&							&			&			&\\
\hline
...
dep-			&{\upshape [}–AGR{\upshape ]}	&$[\textsubscript{\rm NP}[\textsubscript{\rm NP'}$ A:\textsc{nmlz}] (N){\upshape ]}&$[\textsubscript{\rm NP}$ A:\textsc{attr} (N){\upshape ]}&&\textbf{Driven Agreement}&\textbf{Agreement}\\		
			\cline{2-5}
marking		&{\upshape [}+AGR{\upshape ]}	&\textbf{Article}		&\textbf{Anti-Construct Agreement}	&			&[$_{\text{NP}}$ [$_{\text{NP'}}$ A:\textsc{agr}] (N)]&$[\textsubscript{\rm NP}$ A:\textsc{agr} (N){\upshape ]}\\
			&&$[\textsubscript{\rm NP}[\textsubscript{\rm NP'}$ A:\textsc{nmlz:agr}{\upshape ]} (N){\upshape ]}&$[\textsubscript{\rm NP}$ A:\textsc{attr:agr} (N){\upshape ]}&&&\\
\hline
\hline
			&			&			&\textbf{Construct State}						&			&\textbf{Modifier\hyp{}headed}	&\\
head-		&{\upshape [}–AGR{\upshape ]}	&			&$[\textsubscript{\rm NP}$ A *(N:\textsc{attr}){\upshape ]}&&\textbf{Possessor Agreement}&\\
			\cline{2-5}
marking		&{\upshape [}+AGR{\upshape ]}	&			&							&&$[\textsubscript{\rm NP}[\textsubscript{\rm PSD}$ A:\textsc{poss:agr}{\upshape ]} ($\textsubscript{\rm PSR}$N){\upshape ]}&\\
			&			&			&							&&&\\
\hline
\hline
\end{tabular}
