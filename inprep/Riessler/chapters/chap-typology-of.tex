...
\hline
\hline
no			&\textbackslash/&			&\textbf{Juxtaposition}						&\textbf{Incorporation}			&\textbackslash/&\textbackslash/ \\
...
dep-			&$[$–AGR$]$	&$[_{\rm NP}[_{\rm NP'}$ A:\textsc{nmlz}] (N)$]$&$[_{\rm NP}$ A:\textsc{attr} (N)$]$&&\textbf{Driven Agreement}&\textbf{Agreement}\\		
			\cline{2-5}
marking		&$[$+AGR$]$	&\textbf{Article}		&\textbf{Anti-Construct Agreement}	&			&[$_{NP}$ [$_{NP'}$ A \textsc{agr}] (N)]&$[_{\rm NP}$ A \textsc{agr} (N)$]$\\
			&&$[_{\rm NP}[_{\rm NP'}$ A:\textsc{nmlz:agr}$]$ (N)$]$&$[_{\rm NP}$ A:\textsc{attr:agr} (N)$]$&&&\\
\hline
\hline
			&			&			&\textbf{Construct State}						&			&\textbf{Modifier-Headed }	&\\
head-		&$[$–AGR$]$	&			&$[_{\rm NP}$ A *(N:\textsc{attr})$]$&&\textbf{Possessor Agreement}&\\
			\cline{2-5}
