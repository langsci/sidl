...
marking		&\cellcolor{lightgray}&			&{\upshape [}\textsubscript{NP} A (N){\upshape ]}				&{\upshape [}\textsubscript{NP} A *(N){\upshape ]}&\cellcolor{lightgray}&\cellcolor{lightgray}\rule{0pt}{1.3em}\\
% \hline
\hline
\multirow{4}{*}{floating}&\multirow{2}{*}{{\upshape [}–AGR{\upshape ]}	} 			&			&\textbf{Linker}						&			&			&\rule{0pt}{1.3em}\\
	    &&			&{\upshape [}\textsubscript{NP} A {\upshape [}\textsc{attr}{\upshape ]} *(N){\upshape ]}	&			&			&\rule{0pt}{1.3em}\\
 			\cline{2-5}
...
\multirow{4}{*}{dep-marking}			&\multirow{2}{*}{{\upshape [}–AGR{\upshape ]}	} 			&\textbf{Nominalization}&\textbf{Anti-Construct State}			&	&\textbf{Appositional Head-}&\textbf{Head-Driven}\rule{0pt}{1.3em}\\
			& &{\upshape [}\textsubscript{NP}[\textsubscript{NP'} A:\textsc{nmlz}] (N){\upshape ]}&{\upshape [}\textsubscript{NP} A:\textsc{attr} (N){\upshape ]}&&\textbf{Driven Agreement}&\textbf{Agreement}\rule{0pt}{1.3em}\\		
			\cline{2-5}
		&\multirow{2}{*}{{\upshape [}+AGR{\upshape ]}}	&\textbf{Article}		&\textbf{Anti-Construct Agreement}	&			&{\upshape [}\textsubscript{NP} {\upshape [}\textsubscript{NP'} A:\textsc{agr}] (N)]&{\upshape [}\textsubscript{NP} A:\textsc{agr} (N){\upshape ]}\rule{0pt}{1.3em}\\
			&&{\upshape [}\textsubscript{NP}[\textsubscript{NP'} A:\textsc{nmlz:agr}{\upshape ]} (N){\upshape ]}&{\upshape [}\textsubscript{NP} A:\textsc{attr:agr} (N){\upshape ]}&&&\rule{0pt}{1.3em}\\
% \hline
\hline
\multirow{4}{*}{head-marking}			&\multirow{2}{*}{{\upshape [}–AGR{\upshape ]}	} 			&			&\textbf{Construct State}						&			&\textbf{Modifier\hyp{}headed}	&\rule{0pt}{1.3em}\\
 		& 	&			&{\upshape [}\textsubscript{NP} A *(N:\textsc{attr}){\upshape ]}&&\textbf{Possessor Agreement}&\rule{0pt}{1.3em}\\
			\cline{2-5}
 		&\multirow{2}{*}{{\upshape [}+AGR{\upshape ]}}	&			&							&&{\upshape [}\textsubscript{NP}[\textsubscript{PSD} A:\textsc{poss:agr}{\upshape ]} (\textsubscript{PSR}N){\upshape ]}&\rule{0pt}{1.3em}\\
			&			&			&							&&&\rule{0pt}{1.3em}\\
% \hline
\hline
\end{tabular}
