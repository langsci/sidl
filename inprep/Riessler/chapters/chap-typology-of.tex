...
\subsection{Head\slash{}driven agreement} \label{head-driven agreement}
%%%
...
%%%
\begin{itemize}
\item Anti-construct state agreement + Head\slash{}driven agreement
