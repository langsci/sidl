...
\label{german agr}
\end{sidewaystable}
\todo[inline]{LATEX: apply better spacing between columns?}
...
\hline
\hline
			&\multicolumn{4}{c||}{Government {\upshape [}+GOV{\upshape ]} {\upshape [}±(secondary)AGR{\upshape ]}}&\multicolumn{2}{c||}{Agreement {\upshape [}–GOV{\upshape ]} {\upshape [}+(primary)AGR{\upshape ]}}\\
			\cline{2-7}
\textbf{Locus}		&\multicolumn{4}{c||}{\textbf{Syntactic pattern}}&\multicolumn{2}{c||}{\textbf{Syntactic pattern}}\is{syntactic pattern}\is{syntactic locus}\\
			\cline{2-7}
		&{\upshape [}±AGR{\upshape ]}	&Embedded	&Non-embedded			&Incorporated	&Embedded&Non-embedded\\
\hline
\hline
no			&\cellcolor{lightgray}&			&\textbf{Juxtaposition}						&\textbf{Incorporation}			&\cellcolor{lightgray}&\cellcolor{lightgray}\\
marking		&\cellcolor{lightgray}&			&{\upshape [}\textsubscript{\rm NP} A (N){\upshape ]}				&{\upshape [}\textsubscript{\rm NP} A *(N){\upshape ]}&\cellcolor{lightgray}&\cellcolor{lightgray}\\
\hline
\hline
			& 			&			&\textbf{Linker}						&			&			&\\
floating		&{\upshape [}–AGR{\upshape ]}	&			&{\upshape [}\textsubscript{\rm NP} A {\upshape [}\textsc{attr}{\upshape ]} *(N){\upshape ]}	&			&			&\\
 			\cline{2-5}
			&{\upshape [}+AGR{\upshape ]}	&			&							&			&			&\\
			&			&			&							&			&			&\\
\hline
...
dep-			&{\upshape [}–AGR{\upshape ]}	&{\upshape [}\textsubscript{\rm NP}[\textsubscript{\rm NP'} A:\textsc{nmlz}] (N){\upshape ]}&{\upshape [}\textsubscript{\rm NP} A:\textsc{attr} (N){\upshape ]}&&\textbf{Driven Agreement}&\textbf{Agreement}\\		
			\cline{2-5}
marking		&{\upshape [}+AGR{\upshape ]}	&\textbf{Article}		&\textbf{Anti-Construct Agreement}	&			&{\upshape [}\textsubscript{\rm NP} {\upshape [}\textsubscript{\rm NP'} A:\textsc{agr}] (N)]&{\upshape [}\textsubscript{\rm NP} A:\textsc{agr} (N){\upshape ]}\\
			&&{\upshape [}\textsubscript{\rm NP}[\textsubscript{\rm NP'} A:\textsc{nmlz:agr}{\upshape ]} (N){\upshape ]}&{\upshape [}\textsubscript{\rm NP} A:\textsc{attr:agr} (N){\upshape ]}&&&\\
\hline
\hline
			&			&			&\textbf{Construct State}						&			&\textbf{Modifier\hyp{}headed}	&\\
head-		&{\upshape [}–AGR{\upshape ]}	&			&{\upshape [}\textsubscript{\rm NP} A *(N:\textsc{attr}){\upshape ]}&&\textbf{Possessor Agreement}&\\
			\cline{2-5}
marking		&{\upshape [}+AGR{\upshape ]}	&			&							&&{\upshape [}\textsubscript{\rm NP}[\textsubscript{\rm PSD} A:\textsc{poss:agr}{\upshape ]} (\textsubscript{\rm PSR}N){\upshape ]}&\\
			&			&			&							&&&\\
\hline
\hline
\end{tabular}
