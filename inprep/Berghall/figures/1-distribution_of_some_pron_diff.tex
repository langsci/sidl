...
\node	(wakorumba)		[below left=3mm and 17mm of moro, fill=gray!30, rounded corners=5]			{\textsc{(Wakorumba)}};
...
\node (uruplya) [draw, fit=(inowa) (wakorumba) (amiten) (susure), rounded corners=50, inner sep=6mm] {} node at (uruplya.46) [above] {\textit{uruplya}};
