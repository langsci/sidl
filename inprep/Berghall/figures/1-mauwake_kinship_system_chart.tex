...
%Brother of Ego
\node [left=1cm of ego, rectangle, draw] (1br) {Br};
\node [above=.1cm of 1br, regular polygon, regular polygon sides=3, draw] (1BR) {};
%Sister of Ego
\node [right=1cm of ego, rectangle, draw] (z1) {Z};
...
% Ego's cousins on their mother's side
\draw (node cs:name=BR1, anchor=north) |- +(0,.5) -| (node cs:name=Z2) node (TEST) {};
\draw (node cs:name=CO1, anchor=north) |- +(0,.5) -| (node cs:name=CO2);

% Ego's cousins on their father's side
\draw (node cs:name=1Z, anchor=north) |- +(0,.5) -| (node cs:name=2BR);
\draw (node cs:name=1CO, anchor=north) |- +(0,.5) -| (node cs:name=2CO);

% Ego's fathers and his brother and sister
\draw (node cs:name=1FR, anchor=north) |- +(0,.5) -| (node cs:name=1AU);
\draw (node cs:name=1FR, anchor=north) |- +(0,.5) -| (node cs:name=2FR);

% Ego's mother and her brother and sister
\draw (node cs:name=UN1, anchor=north) |- +(0,.5) -| (node cs:name=MO2);
\draw (node cs:name=UN1, anchor=north) |- +(0,.5) -| (node cs:name=MO1);

% Ego's children and nephews/nieces
\draw (node cs:name=1SO, anchor=north) |- +(0,.5) -| (node cs:name=DA1);
\draw (node cs:name=NE1, anchor=north) |- +(0,.5) -| (node cs:name=NE2);
\draw (node cs:name=2SO, anchor=north) |- +(0,.5) -| (node cs:name=1DA);
\draw (node cs:name=3SO, anchor=north) |- +(0,.5) -| (node cs:name=2DA);


% Between-Generation Connections
\draw (node cs:name=1frmo1, anchor=south) -- (node cs:name=EGO, anchor=north);
\draw (node cs:name=fr1mo2, anchor=south) -- ($(fr1mo2)-(0,3.225)$); %This is messy
\draw (node cs:name=un1au1, anchor=south) -- ($(un1au1)-(0,3.225)$); %This is messy
\draw (node cs:name=2fr1mo, anchor=south) -- ($(2fr1mo)-(0,3.225)$); %This is messy
\draw (node cs:name=1un1au, anchor=south) -- ($(1un1au)-(0,3.225)$); %This is messy
\draw (node cs:name=grfa1grmo1, anchor=south) -- ($(grfa1grmo1)-(0,3.225)$); %This is messy
\draw (node cs:name=1grfa1grmo, anchor=south) -- ($(1grfa1grmo)-(0,3.225)$); %This is messy
\draw (node cs:name=1co, anchor=south) -- ($(1co)-(0,3.075)$); %This is messy
\draw (node cs:name=ego, anchor=south) -- ($(ego)-(0,3.075)$); %This is messy
%\draw (node cs:name=1br, anchor=south) -- (node cs:name=NE2) -(5,1); %This is messy
%\draw (node cs:name=z1, anchor=south) -- ($(2SO)-(0,3.225)$); %This is messy
