...
\ea%x1365
\label{ex:x1365}
\gll [\textstyleEmphasizedVernacularWords{No}  \textstyleEmphasizedVernacularWords{nena  maa  fariar-ep}]  \textstyleEmphasizedVernacularWords{muuka  nain} \textstyleEmphasizedVernacularWords{arim-ow-e}.\\
...
\ea%x1366
\label{ex:x1366}
\gll Aite,  [\textstyleEmphasizedVernacularWords{i  aaya=ko  yia  aaw-om-aya}] enim-i-yan. \\
...
\ea%x1369
\label{ex:x1369}
\gll Miiw-aasa  um-eya  miiw-aasa  nain  on-am-ika-iwkin  \textstyleEmphasizedVernacularWords{epa  kokom(a)-ar-e-k,  epa  iimeka  tuun-e-k}.
\\
