...
A simple sentence is the same as a clause, and was discussed in \chapref{5}.
...
For more examples, see \REF{ex:7:x1082}-\REF{ex:7:x1083} in \sectref{sec:7.3} and the introductory section to \chapref{8}. 
