...
\input{figures/1-mean_degrees_of_pronounciation_difference_between_some_Mauwake_villages_map}
\end{figure}

\todo {difference between Meriman and Muaka is unknown from original JPEG. Should it be left empty?}
