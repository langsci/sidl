...
Mauwake is clearly a nominative-accusative type language, rather than ergative-absolutive. The agent of a transitive verb \REF{ex:1:x1523} is marked in the same way as the actor of an intransitive verb \REF{ex:1:1524}, and most experiential verbs have the experiencer as a nominative subject \REF{ex:1:1525}.
...
\paragraph{Mauwake as an \textsc{sov} language}
