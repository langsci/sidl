...
\z
\footnotetext{ \textit{Inasina} ‘a bush spirit’ is commonly used for white-skinned outsiders, \textit{sawur} ‘spirit of long-ago dead’ only rarely.} 
...
\footnotetext{This refers to harvesting the first taros of the year’s crop.}
...
%\setcounter{page}{1} \\
\setcounter{equation}{0}
\section{  Girls’ initiation customs }
 by Kalina Sarak
\ea\label{ex:a:x1}
